...
Realm Agent Studio is the owner operation center for user-owned public Realm Agents as durable Agent IP. It is not a general agent management center. World-created agents, world NPCs, LocalAgent private state, Forge package provenance, and provider/model routing are out of scope.
