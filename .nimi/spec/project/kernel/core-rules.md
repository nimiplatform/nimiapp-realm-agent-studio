...
- **[R-RAS-CORE-007]** Realm Agent Studio MUST keep its owner portfolio scoped to current-authenticated-user `MASTER_OWNED` Realm Agents. `WORLD_OWNED` agents, Forge-imported system curation, generic world-created agents, world NPCs, and world maintainer tooling remain out of scope.
